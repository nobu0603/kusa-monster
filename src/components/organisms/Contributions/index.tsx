            ...
            <div className="w-full">
                <div className="relative flex items-center justify-center flex-col gap-4 w-full h-1/4 md:h-1/6">
                    <div className="flex items-center justify-center flex-col gap-2 md:gap-4">
                        ...
                        <p className={`text-base md:text-3xl ${PixelifySansFont.className}`}>Total Contributions to Date : <span className="font-bold text-green-800">{kusaCount}</span></p>
                        <p className={`text-base md:text-3xl ${PixelifySansFont.className}`}>Total Commits to Date : <span className="font-bold text-green-800">{commitCount}</span></p>
                    </div>
                </div>
            </div>
